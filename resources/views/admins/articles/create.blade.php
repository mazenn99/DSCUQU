                    ...
                    <div class="card-body card-block">
                        <form action="{{route('article.store')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="section" id="section" class="form-control">
                                        @foreach(\App\Models\Section::orderBy('id' , 'DESC')->get() as $section)
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="title" value="{{old('title')}}" name="title" placeholder="Please enter title"
                                           class="form-control">
                                    @error('title')
                                        <small class="text-danger form-text">{{$message}}</small>
                                    @enderror
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="details" id="details" rows="9"
                                              placeholder="please enter details of articles" class="form-control">{{old('details')}}</textarea>
                                    @error('details')
                                    <small class="text-danger form-text">{{$message}}</small>
                                    @enderror
                                </div>
