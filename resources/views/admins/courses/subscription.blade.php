                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!isset($attendsLink))
                            <form action="#">
                                <button id="btnAttend" value="{{$id}}" class="btn btn-outline-primary mb-2"><i class="fa fa-plus" aria-hidden="true"></i>
                                    إصدار رابط الحضور
                                </button>
                            </form>
                        @endif
                        @isset($attendsLink)
                            <div class="form-group">
                                <input type="text" class="form-control" value="{{'http://localhost/DSC-UQU-SITE/public/attend-courses/'.$attendsLink->hash}}">
                            </div>
                        @endisset
